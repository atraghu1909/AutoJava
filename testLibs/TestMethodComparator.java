...
public class TestMethodComparator implements Comparator<ITestNGMethod> {
	 ...
	 * 
	 * int compare =
	 * method1.getRealClass().getName().compareTo(method2.getRealClass().getName
	 * ()); if (compare == 0) { compare =
	 * method1.getMethodName().compareTo(method2.getMethodName()); } return
	 * compare; }
	 */

	public int compare(final ITestNGMethod method1, final ITestNGMethod method2) {
		return extractInt(method1.getRealClass().getName()) - extractInt(method2.getRealClass().getName());
	}
